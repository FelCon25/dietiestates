...
fun AssistantItem(
    ...
    OutlinedCard(
        ...
        Row(
            ...
            Column(
                ...
                if (!assistant.phone.isNullOrEmpty()) {
    ...
    if (showDeleteDialog) {
        AlertDialog(
            ...
            text = { 
                Text("Are you sure you want to delete ${assistant.firstName} ${assistant.lastName}? This action cannot be undone.") 
            },
            confirmButton = {
                TextButton(
                    onClick = {
                        showDeleteDialog = false
                        onDelete?.invoke(assistant.userId)
                    },
